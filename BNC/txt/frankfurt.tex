...
\begin{frame}
  \frametitle{PPP with Ambiguity Resolution (PPPAR or PPP-RTK)}
...
\begin{frame}
  \frametitle{PPPAR Algorithm (cont.)}
...
\begin{frame}
  \frametitle{New Project - GNSS Center}
\hspace*{-5mm}
    \includegraphics[height=0.8\textheight]{gnsscenter.png}
\end{frame}
