...
bncWindow::bncWindow() {
  ...
  pppLayout->addWidget(_pppMountLineEdit,              ir,30, 1, 15, Qt::AlignRight);
  pppLayout->addWidget(new QLabel("Obs."),             ir,45, 1,  5);
  pppLayout->addWidget(_pppCorrMountLineEdit,          ir,50, 1, 13, Qt::AlignRight);
  ...
  pppLayout->addWidget(_pppRefCrdYLineEdit,            ir,35, 1, 10, Qt::AlignRight);
  pppLayout->addWidget(new QLabel("Y"),                ir,45, 1,  5);
  pppLayout->addWidget(_pppRefCrdZLineEdit,            ir,50, 1, 13, Qt::AlignRight);
  ...
  pppLayout->addWidget(_pppRefdELineEdit,              ir,35, 1, 10, Qt::AlignRight);
  pppLayout->addWidget(new QLabel("dE"),               ir,45, 1,  5);
  pppLayout->addWidget(_pppRefdULineEdit,              ir,50, 1, 13, Qt::AlignRight);
  ...
  pppLayout->addWidget(_pppPlotCoordinates,            ir,60, 1, 3);
  ...
  pppLayout->addWidget(_postNavFileChooser,            ir,40, 1, 20);
  pppLayout->addWidget(new QLabel("Nav   "),           ir,60, 1, 5);
  pppLayout->addWidget(_postCorrFileChooser,           ir,65, 1, 22);
  pppLayout->addWidget(new QLabel("Corr"),             ir,87, 1, 5);
  ++ir;
