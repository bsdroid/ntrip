...
bncWindow::bncWindow() {
  ...
  _pppSigCrd0->setWhatsThis(tr("<p>Enter a sigma in meters for the initial XYZ coordinate componentes. A value of 100.0 may be an appropriate choice. However, this value may be significantly smaller (i.e. 0.01) when starting from a station with known XZY position."));
  _pppSigCrdP->setWhatsThis(tr("<p>Enter a sigma in meters for the 'White Noise' of estimated XYZ coordinate components. A value of 100.0 may be appropriate considering the potential movement of a rover position.</p>"));
  ...
  _pppSigCLineEdit->setMaximumWidth(9*ww);
  _pppSigPLineEdit->setMaximumWidth(9*ww);
  _pppSigCrd0->setMaximumWidth(9*ww);
  _pppSigCrdP->setMaximumWidth(9*ww);
