...
bncWindow::bncWindow() {
  ...
  _pppSigCrd0->setWhatsThis(tr("<p>Enter a sigma in meters for the initial XYZ coordinate componentes. A value of 100.0 may be an appropriate choice.</p><p>Note that this value may be significantly smaller (i.e. 0.01) when starting from a known XZY position."));
