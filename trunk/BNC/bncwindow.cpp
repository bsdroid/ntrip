...
bncWindow::bncWindow() {
  ...
  _pppMountLineEdit->setWhatsThis(tr("<p>Specify a mountpoint if you want BNC to derive coordinates for the affected receiver position through a PPP solution.</p><p>Note that PPP in BNC requires to also pull a stream carrying RTCM Version 3 satellite orbit and clock corrections to Broadcast Ephemeris. Pulling in addition a stream carrying Broadcast Ephemeris messages in short repetition rates is suggested.</p>"));
