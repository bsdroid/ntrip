...
_mountPointsTable->setHorizontalHeaderLabels(labels);
  ...
  pppLayout1->addWidget(new QLabel("RINEX Observations"), ir, 2, Qt::AlignLeft);
  pppLayout1->addWidget(_pppWidgets._rinexObs,            ir, 3);
  ++ir;
  pppLayout1->addWidget(new QLabel("RINEX Orbits"),       ir, 2, Qt::AlignLeft);
  pppLayout1->addWidget(_pppWidgets._rinexNav,            ir, 3, 1, 2);
  ++ir;
  pppLayout1->addWidget(new QLabel("Corrections"),        ir, 0, Qt::AlignLeft);
  pppLayout1->addWidget(_pppWidgets._corrHostPort,        ir, 1);
  pppLayout1->addWidget(new QLabel("Corrections"),        ir, 2, Qt::AlignLeft);
  pppLayout1->addWidget(_pppWidgets._corrFile,            ir, 3, 1, 2);
  ++ir;
  pppLayout1->addWidget(new QLabel("<b>Input</b>"),       ir, 0, Qt::AlignLeft);
  pppLayout1->addWidget(new QLabel("<b>Input</b>"),       ir, 3, 1, 2, Qt::AlignLeft);
  ++ir;
  pppLayout1->addWidget(new QLabel("Coordinates"),        ir, 0, Qt::AlignLeft);
  pppLayout1->addWidget(_pppWidgets._crdFile,             ir, 1);
  pppLayout1->addWidget(new QLabel("Log File"),           ir, 3, Qt::AlignLeft);
  ...
  pppLayout1->addWidget(new QLabel("NMEA File"),          ir, 3, Qt::AlignLeft);
  pppLayout1->addWidget(_pppWidgets._nmeaFile,            ir, 4);
  pppLayout1->addWidget(new QLabel("Port"),               ir, 5, Qt::AlignLeft);
