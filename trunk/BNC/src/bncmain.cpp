...
int main(int argc, char* argv[]) {
  ...
  QByteArray printHelp =
      ...
      "           reqcOldAntennadU      <Old up eccentricity>\n"
      ...
      "\n"
      "Outages Panel keys:\n"
      "           adviseObsRate <Observation rate, 0.1 Hz|0.2 Hz|0.5 Hz|1 Hz|5 Hz> \n"
      ...
      "           miscIntr      <Log latency, interval>\n"
      "           miscScanRTCM  <Scan for RTCM message numbers, 0=no, 2=yes>\n"
      ...
      "           PPP/snxtroIntr <SINEX troposphere interval [1 min,2 min,5 min,10 min,15 min,30 min,1 hour,1 day]>\n"
      "\n"
