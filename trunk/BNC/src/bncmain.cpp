...
int main(int argc, char* argv[]) {
  ...
  QByteArray printHelp = 
      ...
      "           --rnxV3          <Version 3, 0=no, 2=yes>\n"
      "           --rnxV3filenames <Version 3 filenames, 0=no, 2=yes>\n"
      "\n"
      "RINEX Ephemeris Panel keys:\n"
      "           --ephPath         <Directory>\n"
      "           --ephIntr         <Interval>\n"
      "           --outEphPort      <Port>\n"
      "           --ephV3           <Version 3, 0=no, 2=yes>\n"
      "           --ephV3filenames  <Version 3 filenames, 0=no, 2=yes>\n"
      "\n"
      ...
      "           --reqcLogSummaryOnly    <Summary output logfile, 0=no, 2=yes>\n"
      "           --reqcSkyPlotSignals    <Plots for signals list>\n"
      "           --reqcPlotDir           <QC plots directory>\n"
      "           --reqcRnxVersion        <RINEX version, 2 or 3>\n"
      ...
      "           --serialHeightNMEASampling <Sampling>\n"
      "\n"
      "Outages Panel keys:\n"
      ...
      "           --snxtroSampl <SINEX troposphere sampling rate>\n"
      "\n"
      ...
      "           --audioResponse    <Audio response [m]>\n"
      "           --useOpenStreetMap <OSM track map, false|true>\n"
      "           --useGoogleMap     <Google track map, false|true>\n"
      ...
      "           --uploadSamplRtcmEphCorr <Orbit sampling [sec]>\n"
      "           --uploadSamplSp3         <SP3 sampling [min]>\n"
      "           --uploadSamplClkRnx      <Clock sampling [sec]>\n"
      "\n"
      "Custom Trafo keys:\n"
